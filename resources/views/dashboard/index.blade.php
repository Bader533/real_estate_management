...
<head>
    ...
    <base href="">
    <title>RealEstateManagement</title>
    ...
    <link rel="shortcut icon" href="{{asset('assets/media/logos/logo-demo-6.svg')}}" />
    ...
    <div class="d-flex flex-column flex-root">
        ...
        <div class="page d-flex flex-row flex-column-fluid">
            ...
            <div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
                ...
                <!--begin::Toolbar-->
                <div id="pageNameRtl" class="toolbar py-2" id="kt_toolbar">
                    <!--begin::Container-->
                    <div id="kt_toolbar_container" class="container-fluid d-flex align-items-center">
                        ...
                        <div class="flex-grow-1 flex-shrink-0 me-5">
                            ...
                            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                                ...
                                <!--begin::Title-->
                                <h1 class="d-flex align-items-center text-dark fw-bolder my-1 fs-3">@yield('pagename')
                                    <!--begin::Separator-->
                                    <span class="h-20px border-gray-200 border-start ms-3 mx-2"></span>
                                    <!--end::Separator-->
                                    <!--begin::Description-->
                                    <small class="text-muted fs-7 fw-bold my-1 ms-1">@yield('object')</small>
                                    <!--end::Description-->
                                </h1>
                                <!--end::Title-->
                            </div>
