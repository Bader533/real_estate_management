                    ...
                    <div class="card-p mt-n20 position-relative">
                        ...
                        <div class="row g-0">
                            ...
                            <div class="col bg-light-warning px-6 py-8 rounded-2 me-7 mb-7">
                                ...
                                <!--end::Svg Icon-->
                                <a href="{{route('compound.index')}}" class="text-warning fw-bold fs-6">Compound</a>
                            </div>
                            <!--end::Col-->
                            <!--begin::Col-->
                            <div class="col bg-light-primary px-6 py-8 rounded-2 mb-7">
                                ...
                                <!--end::Svg Icon-->
                                <a href="{{route('building.index')}}" class="text-primary fw-bold fs-6">Building</a>
                            </div>
                            <!--end::Col-->
                        </div>
                        <!--end::Row-->
                        ...
                        <div class="row g-0">
                            ...
                            <div class="col bg-light-danger px-6 py-8 rounded-2 me-7">
                                ...
                                <!--end::Svg Icon-->
                                <a href="{{route('apartment.index')}}" class="text-danger fw-bold fs-6 mt-2">Unit</a>
                            </div>
                            <!--end::Col-->
                            <!--begin::Col-->
